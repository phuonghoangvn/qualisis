...
export async function POST(
    ...
    try {
        ...
        // 3. Build a structured prompt payload
...
2. For each theme, write a FULL narrative paragraph (150-250 words) that:
...
Be specific, analytical, and evidence-based. Do NOT invent quotes — use only those provided above.`
        ...
        themes.forEach(t => t.codeLinks.forEach(l =>
...
**Total Codes:** ${themes.reduce((acc, t) => acc + t.codeLinks.length, 0)}
...
|---|---|---|
${themes.flatMap(t => t.codeLinks.map(l => {
